<?php
  session_start();
  // echo $_SESSION["s_idx"];
  // $s_id = isset(조건)? A:B; 조건이 참이면 A 거짓이면 B
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/index_multi.css">
  <link rel="stylesheet" type="text/css" href="css/footer.css">
  <link rel="stylesheet" href="css/jquery.bxslider.css">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
  <script type="text/javascript" src="js/jquery-3.6.0.min.js"></script>
  <script src="js/jquuery.bxslider.js"></script>
  <script src="js/index_multi.js"></script>
  <?php
  if($s_id){ ?>
  ...
  <main id="content" class="content"><!-- content -->
    ...
    <div class="activity_bg"><!-- activity_bg -->
      <section class="activity"><!-- activity -->
        ...
        <!-- small_image -->
        <div class="sliderWrap_multipleWrap">
          <ul class="multiple_slider">
            <li><img src="../images/sky_terr_sm.jpg"></li>
            <li><img src="../images/sky_deck_sb.jpg"></li>
            <li><img src="../images/sky_ptzone_sm.jpg"></li>
            <li><a href="#none" class="sky_terr_sm">스카이테라스 보기</a></li>
            <li><a href="#none" class="sky_deck_sb">현재사진</a></li>
            <li><a href="#none" class="sky_ptzone_sm">포토존 보기</a></li>
            <li><a href="#none" class="sky_terr_sm">스카이테라스 보기</a></li>
            <li><a href="#none" class="sky_deck_sb">현재사진</a></li>
            <li><a href="#none" class="sky_ptzone_sm">포토존 보기</a></li>
            <li><a href="#none" class="left">이전</a></li>
            <li><a href="#none" class="right">이후</a></li>
          </ul>
        </div>
    ...
    <div class="gallery_bg"><!-- gallery_bg -->
      <section class="gallery"><!-- gallery -->
        ...
        <ul>
          <li class="gallery_1"><a href="#none">아래서 바라본 롯데타워와 하늘 이미지</a></li>
          <li class="gallery_2"><a href="#none">스카이셔틀 이미지</a></li>
          <li class="gallery_3"><a href="#none">밤에 바라본 롯데타워 이미지</a></li>
          <li class="gallery_4"><a href="#none">전시존 이미지</a></li>
        </ul>
